...
# AuthContext. RSA carries no tenant -> return the same synthetic identity the
# existing verify_signature_auth uses, keeping both RSA paths consistent.
...
async def verify_rsa_auth(request: Request) -> AuthContext:
    """FastAPI dependency: verify X-Signature, return a synthetic AuthContext."""
