...
@shift_analysis_router.post(
    ...
    description=(
        ...
        "**Auth:** RSA signature (server-to-server). Sign the **service-internal** "
        "request line `POST /v1/case-review/shift-analysis` (NOT the public "
        "`/case-review/...` URL — nginx strips that prefix) with your private key "
        "(PKCS#1 v1.5 + SHA-256), base64-encode it, and send as `X-AI-Signature`.\n\n"
        "**Flow:**\n"
