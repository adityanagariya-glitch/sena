...
class Settings(BaseSettings):
    ...
    # Number of past messages to use as memory context
    ...
    # Minimum confidence (0.0–1.0) below which result is marked UNCERTAIN
    CONFIDENCE_THRESHOLD: float = 0.5

    # ── Labels ───────────────────────────────────────────────────────────────
    VALID_LABELS: list[str] = ["emergency", "inappropriate", "normal"]
